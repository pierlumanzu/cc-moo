...
class FeasibleSteepestDescentDSGurobiVersion(DDS, ExtendedGurobiSettings):
    ...
    def compute_direction(self, problem: ExtendedProblem, Jac, x_p=None, time_limit=None):
        ...
        try:
            model = Model('Feasible Steepest Descent Direction')
